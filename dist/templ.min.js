...
this._update();for(var e in this._attrBindings)this._attrBindings[e].update()},t.prototype.destroy=function(){for(var t in this._attrBindings)this._attrBindings[t].destroy()},t}();e.Binding=s,e.binding=i}])});