...
(function (parser_1) {
    parser_1.parser = (function () {
        ...
        function parse(input) {
            var options = arguments.length > 1 ? arguments[1] : {}, peg$FAILED = {}, peg$startRuleIndices = { Start: 0 }, peg$startRuleIndex = 0, peg$consts = [
...
(function (vnode) {
    var FragmentSection = (function () {
        ...
        FragmentSection.prototype.removeChildNodes = function () {
            var node = this.document.createDocumentFragment(), start = this.start;
...
var DynamicRenderer = (function () {
    ...
    DynamicRenderer.prototype.generate = function (root, view) {
        if (!this._refPath)
            this._refPath = vnode.getNodePath(this.ref);
