export var parser = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c7 = function(info) {
              return ["doctype", info.join("")];
            },
        peg$c8 = function(children) { return trimTextExpressions(children); },
        peg$c9 = "<!--",
        ...
        peg$c19 = function(attributes, content) {
        ...
        peg$c57 = function(nodeName, attributes, endTag) {
        ...
        peg$c61 = function(startTag, children, endTag) {
        ...
        peg$c65 = function(info) { return info; },
        peg$c66 = function(info) { return ["element", info.name, info.attributes, []]; },
        peg$c67 = function(name, attrs) {
              return {
                name: name,
                attributes: attrs
              };
        ...
        peg$c71 = function(word) { return word.join(""); },
        peg$c72 = "=",
        peg$c73 = { type: "literal", value: "=", description: "\"=\"" },
        peg$c74 = function(name, values) {
              return ["attribute", name, values];
            },
        peg$c75 = function(name, property) {
        ...
        peg$c81 = function() { return ["string", text()]; },
        peg$c82 = function(values) { return attrValues(values); },
        peg$c83 = "'",
        ...
        peg$c95 = function(condition, left, right) {
        ...
        peg$c138 = function(left, operator, right) {
              return ["operator", operator, left, right];
            },
        peg$c139 = function(value) { return value; },
        peg$c140 = function(expression, modifiers) {
        ...
        peg$c143 = function(name, parameters) {
            return {
              name: name,
              parameters: parameters || []
            };
          },
        peg$c144 = function(context) { return context; },
        peg$c145 = "!",
        peg$c146 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c147 = function(not, value) {
              return ["not", value];
            },
        peg$c148 = function(not, value) {
        ...
        peg$c154 = function(group) { return ["group", group]; },
        ...
        peg$c186 = function(bindingType, reference, path) {
        ...
        peg$c202 = function(firstValue, additionalValues) {
              return [
                firstValue
        ...
        peg$c204 = function(key) { return key[1]; },
        peg$c205 = function(key) { return key; },
