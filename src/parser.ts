        ...
        while (ip < end) {
          switch (bc[ip]) {
            ...
            case 14:
              ...
              if (input.substr(peg$currPos, (<any>peg$consts[bc[ip + 1]]).length) === peg$consts[bc[ip + 1]]) {
                end = ip + 4 + bc[ip + 2];
                ip += 4;
              } else {
            ...
            case 15:
              ...
              if (input.substr(peg$currPos, (<any>peg$consts[bc[ip + 1]]).length).toLowerCase() === peg$consts[bc[ip + 1]]) {
                end = ip + 4 + bc[ip + 2];
                ip += 4;
              } else {
                end = ip + 4 + bc[ip + 2] + bc[ip + 3];
            ...
            case 16:
              ...
              if ((<any>peg$consts[bc[ip + 1]]).test(input.charAt(peg$currPos))) {
                end = ip + 4 + bc[ip + 2];
                ip += 4;
              } else {
                end = ip + 4 + bc[ip + 2] + bc[ip + 3];
            ...
            case 18:
              ...
              peg$currPos += (<any>peg$consts[bc[ip + 1]]).length;
              ip += 2;
              break;
            ...
            case 22:
              ...
              stack.splice(
                ...
                bc[ip + 2],
                (<any>peg$consts[bc[ip + 1]]).apply(null, params)
              );
